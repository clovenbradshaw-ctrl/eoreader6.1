...
export {
  wordCompany, wordKind, defineWord, wordOccurrences, wordSenses,
  hyperlexicon, hyperlexiconEntry, foldHyperlexicon, witnessCast,
  attachHyperlexicon, normalizeVocabulary,
  HYPERLEXICON_SCHEMA, HYPERLEXICON_ENTRY_SCHEMA, HYPERLEXICON_EVENT,
  LEXICON_PRIOR_SCHEMA,
} from "./hyperlexicon.js";
